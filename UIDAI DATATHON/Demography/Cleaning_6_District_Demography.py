...
file_path = r"D:\Aadhar Dataset UIDAI\api_data_aadhar_demographic\api_data_aadhar_demographic\aadhaar_demographic_cleaned.csv"
...
df.loc[df['district'] =='Mohali', 'states_cleaned']='Punjab'
...
df.loc[df['district'] =='Villupuram', 'states_cleaned']='Tamil Nadu'
df.loc[df['district'] =='Cuddalore', 'states_cleaned']='Tamil Nadu'
...
df.loc[df['district'] =='Karim Nagar', 'states_cleaned']='Telangana'
df.loc[df['district'] =='Khammam', 'states_cleaned']='Telangana'
df.loc[df['district'] =='Mahabubnagar', 'states_cleaned']='Telangana'
df.loc[df['district'] =='Mahabub Nagar', 'states_cleaned']='Telangana'
df.loc[df['district'] =='Mahbubnagar', 'states_cleaned']='Telangana'
...
df.loc[df['district'] =='K.V.Rangareddy', 'states_cleaned']='Telangana'
df.loc[df['district'] =='K.v. Rangareddy', 'states_cleaned']='Telangana'
df.loc[df['district'] =='rangareddi', 'states_cleaned']='Telangana'
df.loc[df['district'] =='Rangareddi', 'states_cleaned']='Telangana'
...
df['district'].replace(['Ananthapur','Anantapur','Kadiri Road'],'Ananthapuramu',inplace=True)
...
df['district'].replace('Dantewada','Dakshin Bastar Dantewada', inplace=True)
...
df['district'].replace('ManendragarhChirmiriBharatpur','Manendragarh–Chirmiri–Bharatpur', inplace=True)
df['district'].replace('Kanker','Uttar Bastar Kanker', inplace=True)
...
df['district'].replace(['Bardez','Tiswadi','Bicholim'],'North Goa', inplace=True)
...
df['district'].replace('Near Uday nagar NIT garden','Nagpur', inplace=True)
df['district'].replace(['Raigarh','Raigarh(MH)'],'Raigad', inplace=True)
df['district'].replace('Washim *','Washim', inplace=True)
df['district'].replace('Dist : Thane','Thane', inplace=True)
...
df['district'].replace(['S.A.S Nagar(Mohali)','SAS Nagar (Mohali)','Mohali'],'S.A.S Nagar', inplace=True)
...
df['district'].replace('Near Dhyana Ashram','Chennai', inplace=True)
...
df['district'].replace(['Medchal-malkajgiri','Medchal?malkajgiri','Medchal−malkajgiri','Medchalâ\x88\x92malkajgiri','IDPL COLONY'],'Medchal Malkajgiri', inplace=True)
...
df['district'].replace('Yadadri.','Yadadri', inplace=True)
...
df['district'].replace('Auraiya *','Auraiya', inplace=True)
df['district'].replace(['Bagpat','Baghpat *'],'Baghpat', inplace=True)
df['district'].replace('Chandauli *','Chandauli', inplace=True)
df['district'].replace('Chitrakoot *','Chitrakoot', inplace=True)
df['district'].replace('Barabanki','Bara Banki', inplace=True)
df['district'].replace('Bulandshahar','Bulandshahr', inplace=True)
df['district'].replace('Gautam Buddha Nagar *','Gautam Buddha Nagar', inplace=True)
df['district'].replace(['Sant Ravidas Nagar','Sant Ravidas Nagar Bhadohi'],'Bhadohi',inplace=True)
df['district'].replace(['Jyotiba Phule Nagar','Jyotiba Phule Nagar *'],'Amroha', inplace=True)
...
df['district'].replace('Mahoba *','Mahoba', inplace=True)
...
df['district'].replace('Udham Singh Nagar *','Udham Singh Nagar', inplace=True)
...
df['district'].replace(['24 Paraganas North','North Twenty Four Parganas','South DumDum(M)','Naihati Anandabazar'],'North 24 Parganas', inplace=True)
df['district'].replace(['24 Paraganas South','South 24 parganas','South 24 Pargana','South 24 pargana','South Twenty Four Parganas','South  Twenty Four Parganas'],'South 24 Parganas', inplace=True)
...
df['district'].replace(['HOWRAH','Haora','Hawrah','Domjur','Bally Jagachha'],'Howrah', inplace=True)
...
df['district'].replace(['East Midnapore','East Midnapur','Medinipur','east midnapore','East midnapore'],'Purba Medinipur' , inplace=True)
...
df['district'].replace('udhampur','Udhampur', inplace=True)
...
df.to_csv(r"D:\Aadhar Dataset UIDAI\api_data_aadhar_demographic\api_data_aadhar_demographic\aadhaar_demographic_final_cleaned.csv", index=False)