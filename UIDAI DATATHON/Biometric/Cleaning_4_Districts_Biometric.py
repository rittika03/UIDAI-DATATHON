...
file_path = r"D:\Aadhar Dataset UIDAI\api_data_aadhar_biometric\api_data_aadhar_biometric\aadhaar_biometric_cleaned.csv"
...
df.loc[df['district'] =='Viluppuram', 'states_cleaned']='Tamil Nadu'
...
df['district'].replace(['Ananthapur','Anantapur'],'Ananthapuramu',inplace=True)
...
df['district'].replace(['Bardez','Tiswadi'],'North Goa', inplace=True)
...
df['district'].replace(['Khorda','Khordha  *'],'Khordha', inplace=True)
...
df['district'].replace(['24 Paraganas North','North Twenty Four Parganas','South DumDum(M)'],'North 24 Parganas', inplace=True)
df['district'].replace(['24 Paraganas South','South 24 parganas','South 24 Pargana','South 24 pargana','South Twenty Four Parganas'],'South 24 Parganas', inplace=True)
...
df.to_csv(r"D:\Aadhar Dataset UIDAI\api_data_aadhar_biometric\api_data_aadhar_biometric\aadhaar_biometric_final_cleaned.csv", index=False)